...
# Sample Dataset
PRODUCTS_DATA = [
    {"id": "P001", "name": "Wireless Mouse", "category": "Electronics", "opening_stock": 150, "units_sold": 120, "units_returned": 5, "lead_time": 5, "unit_cost": 15.0, "selling_price": 30.0, "past_demand": [110, 115, 120]},
    {"id": "P002", "name": "Ergonomic Chair", "category": "Furniture", "opening_stock": 40, "units_sold": 35, "units_returned": 2, "lead_time": 14, "unit_cost": 80.0, "selling_price": 150.0, "past_demand": [30, 32, 35]},
    {"id": "P003", "name": "Bluetooth Speaker", "category": "Electronics", "opening_stock": 80, "units_sold": 75, "units_returned": 8, "lead_time": 7, "unit_cost": 25.0, "selling_price": 50.0, "past_demand": [65, 70, 75]},
    {"id": "P004", "name": "Running Shoes", "category": "Apparel", "opening_stock": 200, "units_sold": 180, "units_returned": 12, "lead_time": 10, "unit_cost": 40.0, "selling_price": 90.0, "past_demand": [160, 175, 180]},
    {"id": "P005", "name": "Coffee Maker", "category": "Appliances", "opening_stock": 30, "units_sold": 28, "units_returned": 1, "lead_time": 6, "unit_cost": 60.0, "selling_price": 120.0, "past_demand": [22, 25, 28]},
...
def analyze_inventory(products):
    ...
    for p in products:
        ...
        # 3. Identify products requiring immediate reorder (Safety Stock threshold logic)
        # Using a standard basic reorder trigger rule: current stock covers less than lead time demand
        ...
        # 6. Calculate category-wise profit mapping
...
def read_and_display_top_five(filename="inventory_report.csv"):
    # 10. Read CSV and display top five profitable products
    ...
    # Ensure they are sorted by profit numerically
